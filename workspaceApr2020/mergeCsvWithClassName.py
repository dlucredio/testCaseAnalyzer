...
def countLinesDaniel(mainProjectName, projectName, filePath, testName, dataDaniel):
# Daniel's file:
# mainProjectName = 0
# projectName = 1
...
def countLinesAndrewProjectNameOnly(projectName, filePath, testName, dataAndrew):
# Andrew's file:
# projectName = 0
# testName = 1
# filePath = 2 (ex: optaplanner-core/src/test/java/org/optaplanner/core/api/score/stream/uni/UniConstraintStreamTest.java)
...
def countLinesAndrewMainProjectNameOnly(mainProjectName, filePath, testName, dataAndrew):
# Andrew's file:
# projectName = 0
# testName = 1
# filePath = 2 (ex: optaplanner-core/src/test/java/org/optaplanner/core/api/score/stream/uni/UniConstraintStreamTest.java)
...
def countLinesAndrewProjectNameOnlyWithoutClass(projectName, testName, dataAndrew):
# Andrew's file:
# projectName = 0
# testName = 1
# filePath = 2 (ex: optaplanner-core/src/test/java/org/optaplanner/core/api/score/stream/uni/UniConstraintStreamTest.java)
...
def countLinesAndrewMainProjectNameOnlyWithoutClass(mainProjectName, testName, dataAndrew):
# Andrew's file:
# projectName = 0
# testName = 1
# filePath = 2 (ex: optaplanner-core/src/test/java/org/optaplanner/core/api/score/stream/uni/UniConstraintStreamTest.java)
...
def countLinesAndrewMainProjectAndProjectNames(mainProjectName, projectName, filePath, testName, dataAndrew):
# Andrew's file:
# projectName = 0
# testName = 1
# filePath = 2 (ex: optaplanner-core/src/test/java/org/optaplanner/core/api/score/stream/uni/UniConstraintStreamTest.java)
...
parser.add_argument('csv_file_duplicated_daniel',
                    type=str,
                    help='the file containing methods that have the same names in Daniel\'s file')

parser.add_argument('csv_file_duplicated_andrew',
                    type=str,
                    help='the file containing methods that have the same names in Andrew\'s file')
...
for lineDaniel in dataDaniel:
    ...
    if countLinesDaniel(mainProjectName, projectName, filePath, testName, dataDaniel) > 1:
        duplicateTestCasesDaniel.append(lineDaniel)
    else:
        cla = countLinesAndrewProjectNameOnly(projectName, filePath, testName, dataAndrew)
        if cla == 0:
            cla = countLinesAndrewMainProjectNameOnly(mainProjectName, filePath, testName, dataAndrew)
        if cla == 0:
            cla = countLinesAndrewMainProjectAndProjectNames(mainProjectName, projectName, filePath, testName, dataAndrew)
        if cla == 0:
            cla = countLinesAndrewProjectNameOnlyWithoutClass(projectName, testName, dataAndrew)
        if cla == 0:
            cla = countLinesAndrewMainProjectNameOnlyWithoutClass(mainProjectName, testName, dataAndrew)
        if cla == 0:
            lineDaniel.append('notfound')
        elif cla > 1:
            duplicateTestCasesAndrew.append(lineDaniel)
            lineDaniel.append("duplicated_%i" % cla)
        else:
            lineAndrew = findLineAndrew(mainProjectName, projectName, filePath, testName, dataAndrew)
            if(lineAndrew == None):
                lineAndrew = findLineAndrewWithoutClass(mainProjectName, projectName, testName, dataAndrew)
