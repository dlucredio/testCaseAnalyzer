...
def main():
    parser = argparse.ArgumentParser(
        description='Merges CSV files into one, using JaCoCo metrics')

    parser.add_argument('csv_file_merged',
                        type=str,
                        help='the first file - testCaseAnalyzerPlugin output')

    parser.add_argument('csv_file_jacoco',
                        type=str,
                        help='the second file - coverageAnalyzer output')
